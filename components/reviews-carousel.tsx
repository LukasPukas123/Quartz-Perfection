    ...
    <section id="reviews" className="py-20 md:py-28 bg-[#FAFAFA] overflow-hidden">
      ...
      >
        ...
        >
          {tripleReviews.map((review, index) => (
            ...
            >
              <div className="border border-neutral-200 bg-white p-6 flex flex-col justify-between h-[380px] md:h-[360px] hover:border-[#2B75B8]/50 transition-colors duration-300">
                {/* Stars */}
                <div>
                  <div className="flex gap-0.5 mb-4">
                    {[...Array(review.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-4 h-4 fill-[#2B75B8] text-[#2B75B8]"
                      />
                    ))}
                  </div>
      ...
      <div className="mx-auto px-[5%] sm:px-[8%] md:px-[12%] lg:px-[15%]">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
          ...
          <Button
            asChild
            className="bg-[#2B75B8] text-white hover:bg-[#1E5A94] rounded-none px-8 py-6 text-xs font-semibold tracking-[0.15em] uppercase border-2 border-[#2B75B8] hover:border-[#1E5A94]"
          >
            <a
