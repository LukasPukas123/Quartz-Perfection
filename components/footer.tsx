...
export function Footer() {
  return (
    <footer className="bg-[#0D2E52] text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Premium quartz countertop design and installation services for your home.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-semibold mb-4 tracking-wider">QUICK LINKS</h3>
            <nav className="flex flex-col gap-2">
              ...
              <Link href="/financing" className="text-white/70 hover:text-white text-sm transition-colors">
                Financing
              </Link>
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold mb-4 tracking-wider">SERVICES</h3>
            <nav className="flex flex-col gap-2">
              <Link href="/services" className="text-white/70 hover:text-white text-sm transition-colors">
                Kitchen Countertops
              </Link>
