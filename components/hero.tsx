      ...
      <div className="md:hidden flex flex-col bg-black">
        ...
        <div className="relative bg-black px-6 pt-2 pb-12">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-[#2B75B8] text-[10px] font-semibold tracking-[0.25em] uppercase">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-3 bg-[#2B75B8] hover:bg-[#1E5A94] text-white text-[11px] font-semibold tracking-[0.2em] uppercase px-7 py-4 transition-all duration-300 group"
          >
            Get a Free Quote
      ...
      <section className="relative hidden md:block w-full h-screen min-h-[700px] overflow-hidden bg-black">
        ...
        <div className="absolute bottom-24 left-0 z-20 px-12 lg:px-20 max-w-[65vw] lg:max-w-[55vw]">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-8 h-px bg-[#2B75B8]" />
            <p className="text-[#2B75B8] text-xs font-semibold tracking-[0.25em] uppercase">
              Precision. Quality. Craftsmanship.
            </p>
          </div>
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-3 bg-[#2B75B8] hover:bg-[#1E5A94] text-white text-xs font-semibold tracking-[0.2em] uppercase px-7 py-4 transition-all duration-300 group"
          >
            Get a Free Quote
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" />
          </Link>
